...
parser.add_argument('--load', type=str, default='./smt_base.pth', help='train from checkpoints')
...
parser.add_argument('--edge_root', type=str, default='./TrainDataset/Edge/', help='the training gt images root')
